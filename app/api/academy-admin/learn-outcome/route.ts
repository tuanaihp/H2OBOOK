...
import { loadBlueprintForStage, listBlueprintVersions, loadVersionGraph } from "@/lib/learn-outcome/service";
...
export async function GET(request: Request) {
  ...
  return NextResponse.json({ blueprint, versions, selectedVersionId: versionId ?? null, outcomes });
}
