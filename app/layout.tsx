...
export default function RootLayout({ children }: Readonly<{ children: React.ReactNode }>) {
  ...
  return <html lang="vi" className={`${fontBody.variable} ${fontHeading.variable}`}><body><LocaleProvider><DomTranslator/><AnalyticsProvider/><NeuralRouteTheme/>{children}</LocaleProvider></body></html>;
}
