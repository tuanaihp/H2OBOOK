...
function learnerGroups(context: UserAccessContext): CompactNavGroup[] {
  const groups: CompactNavGroup[] = [
    { id: "home", label: "HOME", items: [{ id: "smart-home", label: "Smart Home", href: "/student" }] },
    {
      ...
      items: ([
        { id: "journey", label: "Hành trình học", href: "/student/courses", feature: "learn.journey" },
        { id: "library", label: "Thư viện học", href: "/student/library", feature: "learn.library" },
        { id: "practice", label: "Thực hành & đánh giá", href: "/student/assignments", feature: "learn.practice" }
