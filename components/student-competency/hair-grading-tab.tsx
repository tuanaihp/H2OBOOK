...
export function HairGradingTab({ classId, organizationId, roster, initialStudentId }: { classId: string; organizationId?: string; roster: { studentId: string; name: string }[]; initialStudentId?: string }) {
  return <GradingForm classId={classId} organizationId={organizationId} roster={roster} initialStudentId={initialStudentId} category="hair" sessionTypeFilter={["practice_hair"]}
